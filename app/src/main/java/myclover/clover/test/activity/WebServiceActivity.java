...
public class WebServiceActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(myclover.clover.test.R.layout.activity_web_service);

        mLogText = (TextView) findViewById(myclover.clover.test.R.id.logText);
        mButton = (Button) findViewById(myclover.clover.test.R.id.button);
